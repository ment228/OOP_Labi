...
class Student:#новый класс Student
    def __init__(self, name, group_number, academic_performance):#функция init c параметрами name, group_number, academic_performance
        self.name = name
...
def byGPA_key(person):#функция ByGPA_key
